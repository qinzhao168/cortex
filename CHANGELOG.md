...
* [CHANGE] Config file changed to remove top level `config_store` field in favor of a nested `alertmanager.store.configdb` field. #2125
...
* [ENHANCEMENT] Alertmanager: Add Go based integration tests #2125
